...
class SheetsCrudController(FilterCrudRestController):
    ...
    __table_options__ = {
        '__omit_fields__': [
            'id', 'description', '_public', 'event_id', 'event', 'teacher',
            '_teacher', 'teacher_id', '_url', '_start_time', '_end_time',
        ],
        '__field_order__': [
            'sheet_id', 'name', 'visibility',
    ...
    __form_options__ = {
        '__omit_fields__': ['id', '_url', '_public', 'assignments', 'teacher', '_teacher'],
        '__hide_fields__': ['event'],
        '__field_order__': [
            'id', 'sheet_id', 'name', 'description',
            'visibility', '_start_time', '_end_time',
        ],
...
class AssignmentsCrudController(FilterCrudRestController):
    ...
    __table_options__ = {
        '__omit_fields__': [
            'id', 'event_id', '_event', '_url', '_public',
            'teacher_id', 'teacher',
            #'allowed_languages',
    ...
    __form_options__ = {
        '__omit_fields__': ['id', 'tests', '_public', 'submissions', '_event', 'teacher', '_url', '_teacher'],
        '__field_order__': [
