...
<%namespace file="local:templates.sheets" import="sheet_list, sheet_list_short" />
<%namespace file="local:templates.news" import="news_list" />
...
% if event.news:
  ...
  ##% else:
    ${news_list((_news for _news in event.news if _news.public))}
  ##% endif
% else:
