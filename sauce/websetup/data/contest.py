...
'''
    ...
    t10.input = open(os.path.join(os.path.dirname(__file__), 'files', 'question')).read()
    t10.output = open(os.path.join(os.path.dirname(__file__), 'files', 'answer')).read()
    Session.add(t10)
    
    s10 = Submission(assignment=a3, language=lp, student=s2)
    s10.source = open(os.path.join(os.path.dirname(__file__), 'files', 'answer.py')).read()
    
    s11 = Submission(assignment=a3, language=lp, student=s2)
    s11.source = open(os.path.join(os.path.dirname(__file__), 'files', 'answer2.py')).read()
